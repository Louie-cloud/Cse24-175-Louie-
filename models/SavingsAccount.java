...
public class SavingsAccount extends models.Account implements InterestBearing {
    private static final double MONTHLY_INTEREST_RATE = 0.0005; // 0.05%

    public SavingsAccount(models.Customer customer, double initialDeposit) {
        super(customer, initialDeposit);
    }

    public SavingsAccount(models.Customer customer, double initialDeposit, String branch) {
    ...
    public String toString() {
        return "%s [Type: Savings, Interest Rate: 0.05%% monthly]".formatted(super.toString());
    }
}